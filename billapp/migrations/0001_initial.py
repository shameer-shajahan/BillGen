# Generated by Django 5.1.4 on 2025-01-08 15:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('owner', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='ex_bill', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Item',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('comp_dtl', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='billapp.company')),
                ('exbill_obj', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ex_bill_items', to='billapp.exbill')),
                ('items_obj', models.ManyToManyField(to='billapp.item')),
                ('receiver_obj', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='billapp.receiver')),
                ('ship_obj', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='billapp.shipto')),
            ],
        ),
    ]
